...
local function applyMorphStatTweaks()
  status.setPersistentEffects("morphStats", { {stat = "fallDamageMultiplier", effectiveMultiplier = 0.0}, {stat = "poisonStatusImmunity", amount = 1.0} })
end
...
function attemptActivation()
  if not self.active
      ...
      and not status.statPositive("sprinting")
...
function deactivate()
  ...
  status.clearPersistentEffects("morphStats")
